...
export const emailData = (requestedProject,project, projectOwner, primaryTechnicalLead, secondaryTechnicalLead, obj) => {
  const objMain = {
    ...
    productionQuotaCPUCurrent: project?project.productionQuota.cpuRequests:null,
    productionQuotaMemoryCurrent: project?project.productionQuota.memoryRequests:null,
    productionQuotaStorageCurrent: project?project.productionQuota.storageFile:null,
    developmentQuotaCPUCurrent: project?project.developmentQuota.cpuRequests:null,
    developmentQuotaMemoryCurrent: project?project.developmentQuota.memoryRequests:null,
    developmentQuotaStorageCurrent: project?project.developmentQuota.storageFile:null,
